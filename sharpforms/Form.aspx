<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form.aspx.cs" Inherits="PLSharpforms.Form" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sharpforms - Form View</title>
   ...
   <div class="outer">
        <div class="inner">
            <div class="ctrl-panel">
                ...
                <div>
                    <form action="Form.aspx?type=view" method="get">
                    Access by ID:&nbsp;<input type="hidden" name="type" value="view" />
